...
import { uploadPaymentProof, validateUploadedImageBytes } from "../middleware/upload.js";
...
orderRouter.post("/orders/:id/payment-proof", ...onlyUser, uploadPaymentProof.single("paymentProof"), validateUploadedImageBytes, uploadPayment);
